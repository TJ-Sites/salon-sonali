...
const socialLinks = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/salon_sonali_?igsh=bzBiNmxvZjF3cTk5",
    icon: (
  ...
  {
    label: "Facebook",
    href: "https://web.facebook.com/sonali.hettiarachch?mibextid=wwXIfr&rdid=wzPbIoYBic0xnkei&share_url=https%3A%2F%2Fweb.facebook.com%2Fshare%2F1GQtearYy5%2F%3Fmibextid%3DwwXIfr%26_rdc%3D1%26_rdr#",
    icon: (
      <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@salon_sonali_minuwangoda?_r=1&_t=ZS-97NjIBBiltN",
    icon: (
      <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer className="bg-[#0E0E10] text-[#F7F6F2]">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="flex gap-4 mt-6">
            {socialLinks.map((s) => (
              <a
                ...
                href={s.href}
                aria-label={s.label}
                className="text-[#6B665F] hover:text-[#B89A7A] transition-colors duration-300"
              >
                {s.icon}
              </a>
            ))}
        ...
        {/* Navigation */}
        <div>
          <h4 className="font-montserrat text-xs tracking-widest uppercase text-[#B89A7A] mb-6">
            Navigation
          </h4>
